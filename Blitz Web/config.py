...
class _Config:
    ...
    SPOTIFY_REDIRECT_URI: str = os.getenv("SPOTIFY_REDIRECT_URI",
                                           "https://blitz-v4.onrender.com/api/sys/spotify/callback")
    ...
    BLITZ_SERVER_URL: str = os.getenv("BLITZ_SERVER_URL", "")
    BLITZ_PUBLIC_URL: str = os.getenv("BLITZ_PUBLIC_URL", "http://localhost:8000")
    ...
    # ── Base System Prompt ────────────────────────────────────────────────────
    BASE_PROMPT: str = """You are Spatial — an advanced, Jarvis-level AI assistant. \
...
• Never say "I'm just an AI" — you are Spatial, a sophisticated system.
