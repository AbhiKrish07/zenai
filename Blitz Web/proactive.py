"""
Spatial Proactive Intelligence — Background cron agents.
...
async def generate_morning_briefing():
    ...
    prompt = f"""You are Spatial, a JARVIS-style AI assistant. Generate a sharp, 3-sentence morning briefing for your user.
